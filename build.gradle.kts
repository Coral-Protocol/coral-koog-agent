...
graalvmNative {
    ...
    binaries {
        named("main") {
             ...
             * 2. building a shadow jar via ./gradlew shadowJar
             * 3. running the app with agentlib:native-image-agent=config-output-dir=src/native-image -jar build/libs/coral-koog-agent-1.0-SNAPSHOT-all.jar
             *
             * Alternatively, use the built-in agent support:
             * ./gradlew run -Pagent
             */
